  ...
  function myFunction(id){
	  ...
	  idName="rodio"+id;
		 ...
		 if($("input:checkbox").is(":Checked")){
			 ...
			   $.get('deleteGroupMemberController',{tableValue:tableId,fileName:},function(responseText) { 
...
<!--  
    ...
    <%
   ResultSet rs=null;
    rs=(ResultSet)session.getAttribute("SessionDeletRequest");
...
<td> <a href="deleteGroupMemberController?userId=<%=rs.getInt(2)%>&fileName=<%=rs.getString(5)%>&userEmail=<%=rs.getString(3)%>"><%=rs.getString(6) %></a></td>
      </tr>
