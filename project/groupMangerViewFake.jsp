...
function  myFunction(id1)
{
	alert("in function");
	 ...
	 if($("input:checkbox").is(":Checked")){
		 ...
		   $.get('DeleteFakeMemberController',{userValue:userId},function(responseText) { 
				
				                            /* alert("in ajax function"); */
				 document.getElementById(statusName).innerHTML = "Remove From Application!";
   ...
   <%
    ...
    <%
   ResultSet rs=null;
    rs=(ResultSet)session.getAttribute("groupMangerFakeSession");
...
<td id="chhavi<%=rs.getInt(1)%>">Fake User !</td>
      </tr>
