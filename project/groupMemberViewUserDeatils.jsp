...
<html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>An Efficient Anti Collusion Data Sharing Mechanism for Data Confidentially for Dynamic Groups | Group Member View Details  </title>
...
<!--  
   <%
    ...
    <%
   ResultSet rs=null;
    rs=(ResultSet)session.getAttribute("GroupMemberUserSession");
