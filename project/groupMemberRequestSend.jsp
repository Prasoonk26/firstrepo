...
<script type="text/javascript">
    ...
    <head>
        ...
        <title>An Efficient Anti Collusion Data Sharing Mechanism for Data Confidentially for Dynamic Groups | View Revoke Request  </title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  <script src="http://code.jquery.com/jquery-latest.js"> </script>
    ...
    <%
    ResultSet rs=(ResultSet)session.getAttribute("groupMemberStatusRevokeRequest");
    %>
