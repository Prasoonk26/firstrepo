...
<html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>An Efficient Anti Collusion Data Sharing Mechanism for Data Confidentially for Dynamic Groups | Group Manger File  Details  </title>
		 ...
		 if($("input:checkbox").is(":Checked")){
			 ...
			 var tableId=document.getElementById(idName).value;
	 		 alert("values are "+tableId);
	 		  ...
	 		  alert("statusName is" +statusName);
			 ...
			   $.get('GroupMangerGetFileDetailsEncrptionController',{tableValue:tableId},function(responseText) { 
					
					                            alert("in ajax function"); 
					
					
					  document.getElementById(statusName).innerHTML = "Send_To_Cloud!";
			 ...
			 {
			 document.getElementById(statusName).innerHTML = "Send_To_Admin!";
			 }
...
<!--  
   <%
    ...
    <%
   ResultSet rs=null;
    rs=(ResultSet)session.getAttribute("groupMangerFileDetailsSession");
...
<td id="chhavi<%=rs.getInt(1)%>"> <%=rs.getString(8) %></td>
      </tr>
