...
function  myFunction(id1)
{
	alert("in function");
	 ...
	 if($("input:checkbox").is(":Checked")){
		 ...
		   $.get('UserRequestSendToCloudServerProviderController',{tableIdValue:tableid},function(responseText) { 
				
				                             alert("in ajax function"); 
				  document.getElementById(statusName).innerHTML = "Request Send !"; 
    ...
    <%
    ResultSet rs=(ResultSet)session.getAttribute("DeleteRequestSession");
    %>
...
<td id="chhavi<%=rs.getInt(1)%>">Delete</td>
      </tr>
