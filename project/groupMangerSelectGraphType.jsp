                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            ...
                            <form  action="AdminGetPerfromacesController" autocomplete="on"> 
                                <h1>Select Type Of Graph </h1> 
                              
                                  <ul>
                                   <li> <input type="radio" name="adminType" value="uploading" checked>uploading</li>
 <li> <input type="radio" name="adminType" value="downloading">Downloading </li>
<!--    <li> <input type="radio" name="adminType" value="revoke" >Revoke</li> -->
