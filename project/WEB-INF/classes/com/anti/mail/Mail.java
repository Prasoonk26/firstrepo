...
public class Mail {
	...
	public void mailSendOTP(String userEmail,String userOtp){
			    ...
			    String from = "optimalcoding769769@gmail.com";  // its chnages by your email id 
				    String pass = "OptimalCoding1234567";       // its also change with email Password 
			    ...
			    try {
					message.setFrom(new InternetAddress(from));
					  ...
					  InternetAddress[] toAddress = new InternetAddress[to.length];
					    ...
					    message.setSubject("Welcome To Anti Collusion  ");
