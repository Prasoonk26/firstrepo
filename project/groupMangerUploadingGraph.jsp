...
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		     <title>An Efficient Anti Collusion Data Sharing Mechanism for Data Confidentially for Dynamic Groups | Group Manger Uploading Graph   </title>
...
$(function () {
    Highcharts.chart('container', {
        ...
        title: {
            text: 'Anti Collusion  In Uploading Time  '
        },
        subtitle: {
            text: ''
        },
