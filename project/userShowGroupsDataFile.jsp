...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  <script src="http://code.jquery.com/jquery-latest.js"> </script>
    ...
    String userName=null,usergroup=null;
    ...
    else
    {
    	System.out.println("have value in session ");
    	 ...
    	 usergroup=userBeans.getUser_group();
...
<td><a href="userDownloadFileGroupController?userId=<%=rs.getInt(1)%>&userEmail=<%=rs.getString(3)%>&userFileName=<%=rs.getString(6)%>&userGroup=<%=rs.getString(5)%>">Download</a></td>
