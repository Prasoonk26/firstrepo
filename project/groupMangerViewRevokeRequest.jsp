...
<script>
	...
	alert("function is entre ");
	 $(document).ready(function() {                        
		                $('#rodio').click(function(event) {  
		                    var username=$('#rodio').val();
...
function  myFunction(id1)
{
	alert("in function");
	 ...
	 if($("input:checkbox").is(":Checked")){
		 ...
		 alert("id value is "+id1);
		 
		  var statusName="chhavi"+id1;
		 ...
		   $.get('GetAllocatedGroupToMemberController',{tableIdValue:tableid},function(responseText) { 
				
				                             alert("in ajax function"); 
				  document.getElementById(statusName).innerHTML = "Allocated!"; 
						
				
			/*  location.reload(true); */
				/*  alert("Out of all Function "); */
   ...
   <%
    ...
    <%
   ResultSet rs=null;
    rs=(ResultSet)session.getAttribute("groupManagerViewRevokeRequestSession");
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li ><a href="WelcomeToManger.jsp">Home</a></li>
                    
                        <li ><a href="#"><%=adminName %></a></li>
                        <li class="active"><a href="#">Group Member View </a></li>
 ...
 -->
  ...
  <tr>
    ...
    <th>Member Name</th>
    <th>Member Email </th>
    <th>Member old Group </th>
    <th>Member Changed  Group </th>
    <th>Member Status </th>
  </tr>
...
while(rs.next()){
 ...
 <tr>
  ...
  <td><input type="checkbox" id="rodio<%=rs.getInt(1)%>" name="Activated" value="<%=rs.getInt(1)%>" onclick="myFunction(<%=rs.getInt(1)%>)"/></td>
...
<td id="chhavi<%=rs.getInt(1)%>"><%=rs.getString(7) %></td>
      </tr>
...
%>
 ...
 <!--    <script type="text/javascript">
    function myFunction(id){
    	...
    	alert("User Id is give as parametre "+id);
    	var arr;
    	if($("input:checkbox").is(":Checked")){
    		
    		/* var userID=$(this).attr("Id");
    		
    		var UserId1=$(this).Prop().value();
    		 */
    	/* 	alert("userid is "+userId);
    		
    		alert("user id of msg"+userId1); */
    		
    		
    		alert("hello CheckBox is on");
    		arr=id;
    		/* arr.puch(id);*/
    		alert("userId is  arr"+arr);
    		alert("userId is  id "+id);
    	...
    	// ajax 
    	 ...
    	 $.ajax({
    	       ...
    	       url:"GetActivatedMemberController",
    	       type:"GET",
    	       dataType:'arr',
    	       data: {'userid':arr}
