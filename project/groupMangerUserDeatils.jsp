...
function  myFunction(id1)
{
	alert("in function");
	 ...
	 if($("input:checkbox").is(":Checked")){
		 ...
		   $.get('GetActivatedMemberController',{userValue:userId},function(responseText) { 
				
				                            /* alert("in ajax function"); */
				 document.getElementById(statusName).innerHTML = "Activated!";
   ...
   <%
    ...
    <%
   ResultSet rs=null;
    rs=(ResultSet)session.getAttribute("adminGetuserDetailsSession");
