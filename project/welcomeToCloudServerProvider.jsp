...
<script type="text/javascript">
    ...
    <head>
        ...
        <title>An Efficient Anti Collusion Data Sharing Mechanism for Data Confidentially for Dynamic Groups | Welcome To Manger  </title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<li ><a href="CloudServerViewMemberFileDeatilsController">Group Member File Details View </a></li>
						<li ><a href="CloudServerProviderViewRequestDeleteController">View Request To User  </a></li>
                    ...
                    <div class="main_features_content2">
                        ...
                        <div class="col-sm-6 margin-top-60">
                            <div class="single_features_right ">
                                <h2>About Us </h2>
                                <p> In cloud providing security, guarantees for the sharing file. In Data Sharing  privacy- preserving is still  challenging issue, untrusted cloud and trusted Cloud due to collusion attack that why we proposed the a secure data sharing scheme for dynamic member for dynamic group. Firstly, we propose a secure way for key distribution and change the private key when user revoke any group then will change with revoked user. Secondly, our scheme can achieve fine grained access control with two factors one is user password and second is one time password. Thirdly, we can protect the scheme from collusion attack, which means that revoked user cannot get the original data file even if they conspire with untrusted cloud</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="main_features_content2">
                        ...
                        <div class="col-sm-6 margin-top-60">
                            <div class="single_features_right ">
                                <h2>Infomation About Anti </h2>
                                <p>To  secure Anti  Collusion resolve the Collusion Attack mainly the user Revoke the register group then he/ she cannot access the Data from Cloud or from Group mainly at time of user Revoke the from Group then Other Group member key will updated. Man in middle Attack are also resolve the in Application when user register with group System Ask many question and that question are ask when user   Download the file that time random question are ask by application if user answer wrong then that user are fake</p>
